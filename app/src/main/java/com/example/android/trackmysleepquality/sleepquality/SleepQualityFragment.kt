...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val sleepQualityFactory = SleepQualityViewModelFactory(arguments.sleepNightKey, datasource)

        val sleepQualityViewModel = ViewModelProvider(this, sleepQualityFactory)
        ...
        sleepQualityViewModel.navigateToSleepTracker.observe(this, Observer {
            if(it==true){
                ...
                sleepQualityViewModel.doneNavigatng()
            }
        })
